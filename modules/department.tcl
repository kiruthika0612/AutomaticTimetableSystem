proc openDepartmentManagement {} {
    ...
    grid .department.forms.dept.save -row 4 -column 0 -columnspan 2 -pady 8
    ...
    grid .department.forms.sec.save -row 4 -column 0 -columnspan 2 -pady 8
...
proc loadDepartmentNames {} {
    ...
    db eval {SELECT department_name FROM departments ORDER BY department_name} row {
        lappend names $row(department_name)
    }
    return $names
}
